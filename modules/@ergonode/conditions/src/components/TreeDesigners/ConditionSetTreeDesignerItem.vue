...
<script>
import ConditionSetTreeDesignerItemDescription from "@Conditions/components/TreeDesigners/ConditionSetTreeDesignerItemDescription";
import ConditionSetTreeDesignerItemParameter from "@Conditions/components/TreeDesigners/ConditionSetTreeDesignerItemParameter";
...
export default {
  ...
  computed: {
    ...mapState("condition", ["conditionsValues"]),
    menuItems() {
      return ["Remove"];
    },
    conditionPhrase() {
