...
<template>
  ...
  >
    <div :class="classes" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave">
      ...
      />
      <span class="workflow-designer-header-layer-cell__title" v-text="title" />
...
import WorkflowDesignerDraggableColumnLayer from "@Workflow/components/Designers/WorkflowDesignerDraggableColumnLayer";
import WorkflowDesignerEditStatusLink from "@Workflow/components/Designers/WorkflowDesignerEditStatusLink";
...
export default {
  ...
  computed: {
    ...
    isAllowedToUpdate() {
      return this.$hasAccess([PRIVILEGES.WORKFLOW.update]);
    },
    isDragged() {
    ...
    classes() {
      return [
        "workflow-designer-header-layer-cell",
        {
          ...
          "workflow-designer-header-layer-cell--right-border": this
            .hasRightBorder
        }
      ];
    },
