...
license details. */
<template>
  <li :class="classes" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave">
    <div class="navigation-side-bar-group__activator" @click="onGroupSelect">
      <Component
    ...
    <template v-if="isExpanded">
      <AutoHeightTransition>
        <ul v-if="isSelected" class="navigation-side-bar-group__items">
    ...
    <ul v-else-if="isHovered" class="navigation-side-bar-group__items">
...
export default {
  ...
  computed: {
    classes() {
      return [
        "navigation-side-bar-group",
        {
          ...
          "navigation-side-bar-group--activated":
            this.isGroupActivated && !this.isSelected,
          "navigation-side-bar-group--hovered": this.isHovered,
          "navigation-side-bar-group--expanded":
    ...
    isGroupActivated() {
      return this.route.routes.some(
        route => this.$route.name && this.$route.name.includes(route.name)
      );
    }
  },
  methods: {
