...
license details. */
<template>
  <EditorMenuBubble :editor="editor" @hide="onHideLinkMenu">
...
<script>
import { GRAPHITE, WHITE } from "@UI/assets/scss/_js-variables/colors.scss";
...
.menububble {
  ...
  display: flex;
  padding: 4px;
  transition: opacity, visibility 0.3s cubic-bezier(0.25, 0.8, 0.5, 1);
  opacity: 0;
