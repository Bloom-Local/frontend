    ...
    <GridCollectionCellActionsPanel>
      <template #prepend>
        <template v-if="isSelectColumn">
          ...
          >
            <CheckBox v-if="multiselect" :value="selected" />
            <RadioButton v-else :value="selected" />
          </div>
        </template>
      </template>
      <template #append>
        ...
        >
          <template #icon="{ color }">
            <IconEdit v-if="data.actions.edit" :fill-color="color" />
            <IconPreview v-else :fill-color="color" />
          </template>
        </Fab>
        <Fab
