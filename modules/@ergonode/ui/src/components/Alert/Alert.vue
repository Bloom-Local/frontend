...
<template>
  <div :class="classes">
    ...
    />
    <span class="alert__title" v-text="message" />
    <Fab :theme="secondaryPlainTheme" @click.native="onRemoveAlert">
      <template #icon="{ color }">
...
export default {
  ...
  computed: {
    ...
    feedbackIconComponent() {
      return () =>
        import(
          `@UI/components/Icons/Feedback/Icon${this.capitalizedAlertType}`
        );
    },
