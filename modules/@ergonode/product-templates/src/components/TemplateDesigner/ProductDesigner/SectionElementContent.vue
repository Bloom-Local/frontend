...
<template>
  ...
  >
    ...
    <div class="vertical-wrapper">
      <span class="element-content__header" v-text="element.label" />
      <span
...
export default {
  ...
  computed: {
    ...mapState("productTemplate", ["types"]),
    smallSize() {
      return SIZE.SMALL;
    },
    secondaryTheme() {
  ...
  methods: {
    ...mapActions("productTemplate", ["removeLayoutElementAtIndex"]),
    ...
    getTypeTranslation(key) {
      ...
      return this.types.find(type => type.variant === "ui" && type.type === key)
        .label;
    }
  }
};
