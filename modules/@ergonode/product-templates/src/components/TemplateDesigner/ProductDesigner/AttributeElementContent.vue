...
<template>
  ...
  >
    ...
    <div
      v-if="!disabled"
      :class="[
        'element-content__contextual-menu',
      ...
      >
        ...
        <template #option="{ option }">
          <ListElementDescription>
            <ListElementTitle :title="option" :size="smallSize" />
          </ListElementDescription>
...
export default {
  ...
  computed: {
    ...mapState("dictionaries", ["attrTypes"]),
    smallSize() {
      return SIZE.SMALL;
    },
    tinySize() {
    ...
    typeIconComponent() {
      const icon = this.$extendedForm({
        key:
          "@Templates/components/TemplateDesigner/ProductDesigner/AttributeElementContent/icons",
      ...
      if (!icon.length) {
        return [
          {
            component: () =>
              import("@Attributes/components/Icons/IconAttributes")
          }
        ];
      }
  ...
  methods: {
    ...
    ...mapActions("feedback", ["onScopeValueChange"]),
